...
%global pkg_name rmf_cmake_uncrustify
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rmf-cmake-uncrustify
Version:        1.2.0
Release:        7%{?dist}
...
%changelog
* Wed Apr 29 2026 Yadunund Vijay <yadunund@openrobotics.org> - 1.2.0-7
- Autogenerated by Bloom

* Tue Apr 28 2026 Yadunund Vijay <yadunund@openrobotics.org> - 1.2.0-6
- Autogenerated by Bloom

* Tue Apr 21 2026 Yadunund Vijay <yadunund@openrobotics.org> - 1.2.0-5
- Autogenerated by Bloom
